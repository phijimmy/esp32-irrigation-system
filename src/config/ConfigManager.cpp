...
void ConfigManager::loadDefaults() {
    ...
    cJSON_AddNumberToObject(configRoot, "irrigation_scheduled_hour", 14); // Set to 13:00
    cJSON_AddNumberToObject(configRoot, "irrigation_scheduled_minute", 58); // Set to 13:15
}
