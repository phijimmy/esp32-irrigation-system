...
void ConfigManager::loadDefaults() {
    ...
    cJSON_AddNumberToObject(configRoot, "irrigation_scheduled_hour", 16); // Set to 13:00
    cJSON_AddNumberToObject(configRoot, "irrigation_scheduled_minute", 10); // Set to 13:15
}
